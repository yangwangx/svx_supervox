...
dataRoot = os.path.join(cwd, 'cityscapes')
imgRoot = os.path.join(dataRoot, 'leftImg8bit_trainvaltest/leftImg8bit/')
seqRoot = os.path.join(dataRoot, 'leftImg8bit_sequence')
gtRoot = os.path.join(dataRoot, 'DAVIS/Annotations/480p/')
valRoot = os.path.join(dataRoot, 'leftImg8bit_trainvaltest/leftImg8bit/train/')  # 00000.jpg
valGTRoot = os.path.join(dataRoot, 'DAVIS/Annotations/480p/')  # 00000.png
testRoot = os.path.join(dataRoot, 'libsvx/PNGImages/')   # 00001.png
